...
import { generateGanttData, formatTime, MACHINE_NAMES, GanttJob } from '../utils/ganttData';
...
interface GanttJobBlockProps {
  job: GanttJob;
  hourWidth: number;
}

const GanttJobBlock: React.FC<GanttJobBlockProps> = ({ job, hourWidth }) => {
  return (
    <Tooltip>
